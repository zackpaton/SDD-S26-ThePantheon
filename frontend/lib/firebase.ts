/**
 * Client-side Firebase initialization: configures the web app and exports the
 * Auth instance for login/sign-up flows.
 */
 ...
 * (same as backend `FIREBASE_DB_URL`) for live chat sync.
 */
