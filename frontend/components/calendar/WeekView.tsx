...
/**
 * Week view: sticky weekday/date row and hour grid share one scroll container
 * so the scrollbar does not narrow columns under the headers; `h-0 flex-1`
 * bounds height so the 24h grid scrolls inside the pane.
 */
...
/**
 * Same column template for header + grid so labels align with day columns
 * (see sticky header in scroll region).
 */
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      >
        <div
          className={
            'sticky top-0 z-20 border-b border-black/15 bg-purple-500 pb-2'
          }
        >
          <div
          ...
          <div
            className={
              'mt-1 grid gap-1 text-center text-xs font-semibold text-black/80'
            }
            style={{gridTemplateColumns: WEEK_GRID_COLS}}
          >
                  ...
                  <span
                    className={
                      isToday ?
                        ...
                        'inline-flex min-h-[1.75rem] min-w-[1.75rem] ' +
        ...
        >
          <div
            className={
              'select-none rounded border border-black/20 bg-white/90 p-0.5'
            }
          >
            {HOURS.map((h) => (
              <div
                ...
                className={
                  'relative pr-0.5 text-right text-[10px] text-gray-500'
                }
              >
                <span
            ...
            return (
              <div
                ...
                className={
                  ...
                  `border-black bg-white p-1 text-sm ${
                    isToday ? todayRing : ''
                  }`
                }
                  ...
                  {isToday && (
                    ...
                    >
                      <div className="relative h-0.5 bg-red-500">
                        <span
                          className={
                            'absolute -left-0.5 -top-1 h-2 w-2 rounded-full ' +
                            'bg-red-500'
                          }
                        />
                      </div>
                  ...
                  {dayEvents.map((event) => {
                    ...
                    return (
                      <button
                        ...
                        className={
                          `absolute z-[5] overflow-hidden rounded px-0.5 ` +
                          `py-0.5 text-left text-[10px] leading-tight ` +
                          `text-white shadow-sm hover:brightness-110 ` +
                          `focus:outline-none focus:ring-2 ` +
                          `focus:ring-blue-400 ${colorClass}`
                        }
                        style={{
                          top: `${layout.topPct}%`,
                      ...
                      >
                        <div className="relative h-full min-h-0 w-full">
                          ...
                          <span
                            className={
                              'block truncate pr-3.5 font-semibold ' +
                              'leading-tight'
                            }
                          >
                            {event.title}
                          ...
                          <span
                            className={
                              'block truncate pr-3.5 text-[9px] ' +
