...
/**
 * Calendar shell: shared board state, header, month or week grid, sidebar
 * filters, and modals.
 */
  ...
  return (
    <div
      className={
        ...
        'border-2 border-black bg-purple-500 p-2 shadow sm:rounded-xl sm:p-4'
      }
    >
      <CalendarHeader
        view={view}
      ...
      >
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
          {view === 'month' && (
            <MonthView currentDate={currentDate} board={board} />
          )}
          {view === 'week' && (
            <WeekView currentDate={currentDate} board={board} />
          )}
        </div>
